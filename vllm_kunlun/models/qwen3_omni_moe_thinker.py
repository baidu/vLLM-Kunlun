...
# form vllm-0.11.2 /usr/local/lib/python3.12/dist-packages/vllm/model_executor/models/vision.py
...
class Qwen3OmniMoeThinkerMultiModalProcessor(
    ...
    def _maybe_apply_prompt_updates(
        ...
        # normal case with `use_audio_in_video=False`
            ...
            prompt_ids, new_text, mm_placeholders = self._apply_prompt_updates(
                prompt_ids,
                mm_prompt_updates,
            )
            self._validate_mm_placeholders(
        ...
        return prompt_ids, new_text, mm_placeholders
