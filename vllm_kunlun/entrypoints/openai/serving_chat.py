...
class OpenAIServingChat(OpenAIServing):
    ...
    def _create_reasoning_parser(
        ...
        if getattr(
            ...
            parser_kwargs["chat_template_kwargs"] = request.chat_template_kwargs
        return self.reasoning_parser(tokenizer, **parser_kwargs)
    ...
    async def chat_completion_stream_generator(
        ...
        try:
            if self.reasoning_parser:
                reasoning_parser = self._create_reasoning_parser(tokenizer, request)
